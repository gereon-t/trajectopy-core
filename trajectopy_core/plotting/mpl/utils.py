...
def vertical_subplots(
    *,
    ...
    """
    fig, axes = plt.subplots(nrows=len(y_list[0]), ncols=1, sharex=sharex, sharey=sharey)
...
def _colored_scatter_plot(
    *, xyz: np.ndarray, c_list: list, c_label: str, title: str, plot_settings: MPLPlotSettings = MPLPlotSettings()
) -> None:
    """
